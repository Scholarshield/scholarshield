                    ...
                    <div class="row">
                    	<div class="col-md-3 col-sm-6">
                    		<div class="panel panel-default">
                    			...
                    			<div class="panel-body text-center">
                    				<a href="#" class="btn btn-lg btn-rounded btn-default">PURCHASE</a>
                    	...
                    	<div class="col-md-3 col-sm-6">
                    		<div class="panel panel-default float-shadow" style="width:100%">
                    			...
                    			<div class="panel-body text-center">
                    				<a href="#" class="btn btn-lg btn-rounded btn-primary">PURCHASE</a>
                    			</div><!--/as pricing footer-->
                    		</div><!--/as pricing table-->
                    	</div><!--/cols-->
                    		...
                    		<div class="panel panel-animated panel-default">
                				...
                				<div class="panel-footer bg-cloud text-center">
                    				...
                    				<p class="helper-block">
                    					<a href="#" class="btn btn-lg btn-warning">PURCHASE</a>
                    				</p>
                    			</div><!--/as pricing body-->
                    		</div><!--/as pricing table-->
                    	</div><!--/cols-->
                    	...
                    	<div class="col-md-3 col-sm-6">
                    		<div class="panel panel-animated panel-default">
                				...
                				<div class="panel-footer bg-cloud text-center">
                					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero, doloribus rem sunt debitis excepturi at!</p>
                    				<p class="helper-block">
                    					<a href="#" class="btn btn-lg btn-danger">PURCHASE</a>
                    				</p>
                    			</div><!--/as pricing body-->
                    		</div><!--/as pricing table-->
                    	</div><!--/cols-->
                    	...
                    	<div class="col-md-3 col-sm-6">
                    		<div class="panel panel-default border-inverse hover">
                				...
                				<div class="panel-footer bg-inverse text-center">
                					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero, doloribus rem sunt debitis excepturi at!</p>
                    				<p class="helper-block">
                    					<a href="#" class="btn btn-lg btn-primary">PURCHASE</a>
                    				</p>
                    			</div><!--/as pricing body-->
                    		</div><!--/as pricing table-->
                    	</div><!--/cols-->
                    	...
                    	<div class="col-md-3 col-sm-6">
                    		<div class="panel panel-animated panel-default">
                				...
                				<div class="panel-footer bg-cloud text-center">
                					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero, doloribus rem sunt debitis excepturi at!</p>
                    				<p class="helper-block">
                    					<a href="#" class="btn btn-lg btn-success">PURCHASE</a>
                    				</p>
                    			</div><!--/as pricing body-->
                    		</div><!--/as pricing table-->
                    	</div><!--/cols-->
                    	...
                    	<div class="col-md-3 col-sm-6">
                    		<div class="panel panel-animated panel-warning">
                				...
                				<div class="panel-footer bg-white text-center">
                    				...
                    				<p class="helper-block">
                    					<a href="#" class="btn btn-block btn-lg btn-warning">PURCHASE</a>
                    				</p>
                    			</div><!--/as pricing body-->
                    		</div><!--/as pricing table-->
                    	</div><!--/cols-->
                    	...
                    	<div class="col-md-3 col-sm-6">
                    		<div class="panel panel-animated panel-danger">
                				...
                				<div class="panel-footer bg-white text-center">
                    				...
                    				<p class="helper-block">
                    					<a href="#" class="btn btn-block btn-lg btn-danger">PURCHASE</a>
                    				</p>
                    			</div><!--/as pricing body-->
                    		</div><!--/as pricing table-->
                    	</div><!--/cols-->
                    	...
                    	<div class="col-md-3 col-sm-6">
                    		<div class="panel panel-animated panel-primary">
                				...
                				<div class="panel-footer bg-white text-center">
                    				...
                    				<p class="helper-block">
                    					<a href="#" class="btn btn-block btn-lg btn-primary">PURCHASE</a>
                    				</p>
                    			</div><!--/as pricing body-->
                    		</div><!--/as pricing table-->
                    	</div><!--/cols-->
                    	...
                    	<div class="col-md-3 col-sm-6">
                    		<div class="panel panel-animated panel-success">
                				...
                				<div class="panel-footer bg-white text-center">
                    				...
                    				<p class="helper-block">
                    					<a href="#" class="btn btn-block btn-lg btn-success">PURCHASE</a>
                    				</p>
                    			</div><!--/as pricing body-->
                    		</div><!--/as pricing table-->
                    	</div><!--/cols-->
            						...
            						<li class="col-xs-4 helper-block-sm absolute-center bg-cloud">
            							<div class="absolute-center-item" style="width:100%">
	            							<p class="helper-block margin-left margin-right">
		                    					<a href="#" class="btn btn-block btn-lg btn-rounded btn-warning">PURCHASE</a>
		                    				</p>
            							</div>
            						</li>
            					</ul>
                    		...
                    		<div class="panel panel-animated panel-inverse no-border no-shadow">
                				<ul class="row">
            						...
            						<li class="col-xs-4 helper-block-sm absolute-center bg-cloud">
            							<div class="absolute-center-item" style="width:100%">
	            							<p class="helper-block margin-left margin-right">
		                    					<a href="#" class="btn btn-block btn-lg btn-rounded btn-danger">PURCHASE</a>
		                    				</p>
            							</div>
            						</li>
            					</ul>
                    		...
                    		<div class="panel panel-animated panel-inverse no-border no-shadow">
                				<ul class="row">
            						...
            						<li class="col-xs-4 helper-block-sm absolute-center bg-primary">
            							<div class="absolute-center-item" style="width:100%">
	            							<p class="helper-block margin-left margin-right">
		                    					<a href="#" class="btn btn-block btn-lg btn-rounded btn-transparent">PURCHASE</a>
		                    				</p>
            							</div>
            						</li>
            					</ul>
                    		...
                    		<div class="panel panel-animated panel-inverse no-border no-shadow">
                				<ul class="row">
            						...
            						<li class="col-xs-4 helper-block-sm absolute-center bg-cloud">
            							<div class="absolute-center-item" style="width:100%">
	            							<p class="helper-block margin-left margin-right">
		                    					<a href="#" class="btn btn-block btn-lg btn-rounded btn-success">PURCHASE</a>
		                    				</p>
            							</div>
            						</li>
            					</ul>
